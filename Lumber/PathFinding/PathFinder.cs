...
namespace Lumber.PathFinding
{
    public class PathFinder
    {
        ...
        public PathFinder(SearchParameters searchParameters)
        {
            ...
            InitializeNodes(searchParameters.Fields);
        ...
        private void InitializeNodes(List<Field> map)
        {

            nodes = new List<Node>();
            foreach (var f in map.Where(x => x.IsWalkable))
            {
                nodes.Add(new Node(f.X,f.Y, f.IsWalkable, searchParameters.EndLocation));
            }
        }
